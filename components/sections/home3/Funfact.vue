          ...
          <div class="title-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column">
              <div class="sec-title light">
                <span class="sub-title">funfact</span>
          ...
          <div class="column col-lg-6 col-md-12 col-sm-12">
            <div class="fact-counter">
              <div class="row">
                ...
                <div class="counter-block-new-3 col-lg-4 col-md-4 col-sm-12 wow fadeInUp">
                  <div class="inner">
                    <div class="content">
                      ...
                      <div class="count-box"><ElementsCounterUp :end="6420" /></div>
                ...
                <!--Counter block-->
                <div class="counter-block-new-3 col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
                  <div class="inner">
                    <div class="content">
                      <i class="icon flaticon-recommend"></i>
                      <div class="count-box"><ElementsCounterUp :end="9280" /></div>
                ...
                <!--Counter block-->
                <div class="counter-block-new-3 col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
                  <div class="inner">
                    <div class="content">
                      <i class="icon flaticon-teaching"></i>
                      <div class="count-box"><ElementsCounterUp :end="380" /></div>
