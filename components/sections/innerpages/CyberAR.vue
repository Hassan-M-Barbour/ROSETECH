      ...
      <NuxtLink to="#" class="theme-btn btn-style-one d-grid"><span class="btn-title"><span class="fas fa-file-pdf"></span> download pdf file</span></NuxtLink>
        ...
        <div class="col-xl-8 col-lg-8">
          <div class="services-details__content">
            ...
            <h3 class="mt-4">الأمن السيبراني</h3>
            <p style="text-align: justify">
              تقدم حلولنا الشاملة للأمن السيبراني حماية كاملة لأعمالك ضد
              التهديدات الرقمية المتطورة. نؤمن بياناتك، ونحمي شبكتك، ونتأكد من
              أن أنظمتك مقاومة للهجمات الإلكترونية. مع خدماتنا الاحترافية، يمكنك
              التركيز بثقة على أعمالك ونحن نتولى جميع احتياجاتك الأمنية.
            </p>
