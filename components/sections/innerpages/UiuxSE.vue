              ...
              <div class="sidebar-widget service-sidebar-single">
                ...
                <div class="sidebar-service-list">
                  <ul>
                    ...
                    <li  ><NuxtLink to="graphic-design"><i class="fas fa-angle-right"></i><span>Grafisk Design</span></NuxtLink></li>
                    <li class="current"><NuxtLink to="ui-ux-design"><i class="fas fa-angle-right"></i><span>UI / UX Design</span></NuxtLink></li>
          ...
          <div class="col-xl-8 col-lg-8">
            <div class="services-details__content">
              ...
              <p style="text-align: justify;">
                ...
                Ge dig ut på en användarcentrerad resa med våra professionella UI/UX-tjänster. Vår expertis är sömlöst integrerad i din webbplats och förbättrar användarupplevelsen till en helt ny nivå. Vi tror på att skapa gränssnitt som inte bara fängslar utan också engagerar, vilket säkerställer att din digitala närvaro sticker ut i ett myllrande onlinelandskap.   
            </p>
