        ...
        <div class="row">
          ...
          <div class="col-xl-8 col-lg-8">
            <div class="services-details__content">
              ...
              <h3 class="mt-4">تطوير تطبيقات الويب</h3>
              <p style="text-align: justify;">
                استمتع بخدمات تطوير تطبيقات الويب المتكاملة التي تتناغم بسلاسة مع نظامك الرقمي. يقوم فريقنا المحترف من المطورين بتحويل أفكارك إلى واقع، حيث نقدم لك تطبيقات ويب قوية وقابلة للتوسع مصممة خصيصًا لتلبية احتياجات عملك الفريدة. دعنا نكون دعامة نجاحك في العالم الرقمي.
              </p>
