      ...
      <NuxtLink to="#" class="theme-btn btn-style-one d-grid"><span class="btn-title"><span class="fas fa-file-pdf"></span> download pdf file</span></NuxtLink>
        ...
        <div class="col-xl-8 col-lg-8">
          <div class="services-details__content">
            ...
            <h3 class="mt-4">خدمات التصميم الجرافيكي</h3>
            <p style="text-align: justify">
              نحن متحمسون لتقديم خدمات التصميم الجرافيكي الاحترافية التي تنسجم
              بسلاسة مع هويتك التجارية. بفضل خبرتنا، يمكننا تعزيز العلامة
              التجارية الخاصة بك من خلال تصميم رسومات لافتة للنظر وأنماط بصرية
              فريدة. سواء كنت تبحث عن إعادة تصميم شاملة لعلامتك التجارية أو ترغب
              في إجراء تعديلات طفيفة، نحن هنا لمساعدتك في تحسين صورة علامتك
              التجارية لتحقيق تأثير أكبر وزيادة التفاعل. تواصل معنا اليوم
              لمناقشة احتياجاتك الخاصة، ودعنا نساعدك في إنشاء هوية بصرية تميزك
              عن المنافسين.
            </p>
