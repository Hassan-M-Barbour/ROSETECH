      ...
      <NuxtLink to="#" class="theme-btn btn-style-one d-grid"><span class="btn-title"><span class="fas fa-file-pdf"></span> download pdf file</span></NuxtLink>
        ...
        <div class="col-xl-8 col-lg-8">
          <div class="services-details__content">
            ...
            <h3 class="mt-4">تطوير تطبيقات الموبايل</h3>
            <p style="text-align: justify">
              حوّل تجربة استخدامك للهاتف المحمول مع خدمات تطوير التطبيقات
              المتميزة التي نقدمها. من مرحلة الفكرة إلى التنفيذ، يضمن فريقنا أن
              تطبيقك ليس فقط يحقق توقعات المستخدمين بل يتجاوزها أيضًا. استثمر في
              قوة التخصيص والابتكار للحصول على تجربة موبايل فريدة حقًا.
            </p>
