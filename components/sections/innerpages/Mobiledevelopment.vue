        ...
        <div class="row">
            ...
            <div class="service-sidebar">
              ...
              <div class="sidebar-widget service-sidebar-single">
                ...
                <div class="sidebar-service-list">
                  <ul>
                    <li ><NuxtLink to="website-development" class="current"><i class="fas fa-angle-right"></i><span>Web Apps Development</span></NuxtLink></li>
                    <li ><NuxtLink to="graphic-design"><i class="fas fa-angle-right"></i><span>Graphic Designing</span></NuxtLink></li>
                    <li><NuxtLink to="ui-ux-design"><i class="fas fa-angle-right"></i><span>UI / UX Designing</span></NuxtLink></li>
                    <li class="current"><NuxtLink to="mobile-apps-development"><i class="fas fa-angle-right"></i><span>Mobile Apps Development</span></NuxtLink></li>
                     </ul>
                </div>
          ...
          <div class="col-xl-8 col-lg-8">
            <div class="services-details__content">
              ...
              <h3 class="mt-4">Mobile Applications Development</h3>
              <p style="text-align: justify;">
                Transform your mobile presence with our seamless mobile app development services. From concept to deployment, our team ensures your mobile application not only meets but exceeds user expectations. Unleash the power of customization and innovation for a truly unique mobile experience.
            </p>
