        ...
        <div class="col-xl-8 col-lg-8">
          <div class="services-details__content">
            ...
            <p style="text-align: justify">
              انطلق في رحلة مخصصة للمستخدم مع خدماتنا الرائدة في تصميم واجهات
              وتجارب المستخدم. بفضل معرفتنا الواسعة في هذا المجال، نعمل على
              تعزيز تجارب المستخدمين إلى مستويات متقدمة. نحن نؤمن بأن تصميم
              الواجهات يجب أن يكون جذابًا وعمليًا، مما يضمن لك التميز في فضاء
              الإنترنت المليء بالتنافس.
            </p>
