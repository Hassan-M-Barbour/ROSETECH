      ...
      <div class="row">
        ...
        <div class="col-xl-8 col-lg-8">
          <div class="services-details__content">
            ...
            <h3 class="mt-4">UI / UX Services</h3>
            <p style="text-align: justify">
              Embark on a user-centric journey with our professional UI/UX
              services. Seamlessly integrated into your website, our expertise
              enhances user experiences to a whole new level. We believe in
              crafting interfaces that not only captivate but also engage,
              ensuring your digital presence stands out in a crowded online
              landscape.
            </p>
