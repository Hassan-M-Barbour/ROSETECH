          ...
          <!-- <form method="post" action="/api/send" id="contact-form"> -->
            ...
            <div class="row">
              ...
              <div class="form-group col-lg-6 col-md-12 col-sm-12">
                <input type="text" v-model="name" name="full_name" placeholder="Your name" required>
              </div>
              <div class="form-group col-lg-6 col-md-12 col-sm-12">
                <input type="email" name="Email" v-model="email" placeholder="Email Address" required>
              </div>
              <div class="form-group col-lg-12">
                <textarea name="message" v-model="message" placeholder="Write a message" required minlength="8"></textarea>
              </div>
              <div class="form-group col-lg-12">
