      ...
      <div class="sec-title light">
        <div class="row">
          <div class="col-lg-7">
            ...
            <h2>دعونا نبني المستقبل معًا</h2>
          </div>
          <div class="col-lg-5">
            <div class="text">اكتشف الخدمات التي نقدمها</div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="service-block col-lg-3 col-md-6 wow fadeInUp">
          <div class="inner-box">
            ...
            <div class="content-box">
              ...
              <h5 class="title">تطوير <br />تطبيقات الويب</h5>
            </div>
            <div class="hover-content">
              <i class="icon flaticon-web-development"></i>
              <h5 class="title">
                <NuxtLink to="website-development"
                  >تطوير <br />تطبيقات الويب</NuxtLink
                >
              </h5>
              <div class="text">
                استمتع بخدمات تطوير تطبيقات الويب الشاملة ...
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="service-block col-lg-3 col-md-6 wow fadeInUp">
          <div class="inner-box">
            ...
            <div class="content-box">
              ...
              <h5 class="title">تصميم <br />الغرافيك</h5>
            </div>
            <div class="hover-content">
              <i class="icon flaticon-design"></i>
              <h5 class="title">
                <NuxtLink to="graphic-design">تصميم <br />الغرافيك</NuxtLink>
              </h5>
              <div class="text">
                يسعدنا أن نقدم خدمات التصميم الجرافيكي الاحترافية التي تتوافق
                بسلاسة مع...
              </div>
            </div>
          </div>
        ...
        <div class="service-block col-lg-3 col-md-6 wow fadeInUp">
          <div class="inner-box">
            ...
            <div class="content-box">
              ...
              <h5 class="title">تصميم <br />واجهة المستخدم / تجربة المستخدم</h5>
            </div>
            <div class="hover-content">
              <i class="icon flaticon-megaphone"></i>
              <h5 class="title">
                <NuxtLink to="ui-ux-design">
                  تصميم <br />واجهة المستخدم / تجربة المستخدم
                </NuxtLink>
              </h5>
              <div class="text">
                انطلق في رحلة تركز على المستخدم مع خدمات UI/UX الاحترافية
                لدينا....
              </div>
            </div>
          </div>
        ...
        <div class="service-block col-lg-3 col-md-6 wow fadeInUp">
          <div class="inner-box">
            ...
            <div class="content-box">
              ...
              <h5 class="title">تطبيقات<br />الموبايل</h5>
            </div>
            <div class="hover-content">
              <i class="icon flaticon-visitor"></i>
              <h5 class="title">
                <NuxtLink to="mobile-apps-development"
                  >تطبيقات <br />الموبايل</NuxtLink
                >
              </h5>
              <div class="text">
        ...
        <div class="service-block col-lg-3 col-md-6 wow fadeInUp">
          <div class="inner-box">
            ...
            <div class="content-box">
              <i class="icon flaticon-visitor"></i>
              <h5 class="title">الأمن السيبراني</h5>
            </div>
            <div class="hover-content">
              <i class="icon flaticon-visitor"></i>
              <h5 class="title">
        ...
        <div class="service-block col-lg-3 col-md-6 wow fadeInUp">
          <div class="inner-box">
            ...
            <div class="content-box">
              <i class="icon flaticon-visitor"></i>
              <h5 class="title">تحسين محركات البحث</h5>
            </div>
            <div class="hover-content">
              <i class="icon flaticon-visitor"></i>
              <h5 class="title">
