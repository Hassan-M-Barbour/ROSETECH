    ...
    <section class="call-to-action">
      ...
      <div class="auto-container">
        <div class="outer-box wow fadeIn">
          ...
          <h2 class="title">ROSETECH  <br>Ta ditt företag till nästa nivå</h2>
          <NuxtLink to="/contact" class="theme-btn btn-style-one light"><span class="btn-title">Upptäck Mer</span></NuxtLink>
        </div>
      </div>
    </section>
  </template>