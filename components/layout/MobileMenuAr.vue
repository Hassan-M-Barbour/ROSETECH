...
<template>
  ...
  <ul class="navigation clearfix">
    ...
    <li @click="handleToggled" class="dropdown" :class="{ 'current': isActive.key === 1 }">
      <NuxtLink to="/en">الرئيسية</NuxtLink>
    ...
    <li @click="handleToggled">
      <NuxtLink to="/ar/about">من نحن</NuxtLink>
    </li>
    <li @click="handleToggled"><NuxtLink to="/ar/team" >فريقنا</NuxtLink></li>
    <li @click="handleToggled"><NuxtLink to="/ar/projects">مشاريعنا</NuxtLink></li>
    <li @click="handleToggled"><NuxtLink to="/ar/news">الأخبار</NuxtLink></li>
    ...
    <li @click="handleToggled">
      <NuxtLink to="/en/contact">اتصل بنا</NuxtLink>
    </li>
