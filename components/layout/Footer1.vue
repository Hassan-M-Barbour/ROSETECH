<template>
  <footer class="main-footer">
          ...
          <div class="footer-column col-xl-6 col-lg-6">
            <div class="footer-widget about-widget">
              <div class="widget-content">
                ...
                <div class="text">Welcome to our Company. with ROSETECH you can empower your business.</div>
            ...
            <div class="widget links-widget">
              ...
              <div class="widget-content">
                <ul class="user-links two-column">
                  <li><NuxtLink to="/team">Meet Our Team</NuxtLink></li>
                  <li><NuxtLink to="/about">About</NuxtLink></li>
                  <li><NuxtLink to="/services">What We Do</NuxtLink></li>
                  <li><NuxtLink to="/contact">Support</NuxtLink></li>
                  <li><NuxtLink to="/news">Latest News</NuxtLink></li>
                  <li><NuxtLink to="/projects">New Projects</NuxtLink></li>
    ...
    <div class="footer-bottom">
      <div class="auto-container">
        <div class="copyright-text">© Copyright {{new Date().getFullYear()}} reserved by ROSETECH</div>
      </div>
    </div>
  </footer>
</template>